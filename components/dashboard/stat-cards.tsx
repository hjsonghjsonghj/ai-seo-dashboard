    ...
    >
      <CardContent className="p-5">
        ...
        <div className="mt-5 space-y-3">
          <div className="flex items-center gap-1.5 text-body-micro-medium">
            <span className="font-medium text-foreground-tertiary">Goal:</span>
          ...
          <div className="flex items-center gap-1.5 pt-1">
            ...
            <span className={cn("text-body-micro-medium font-bold tabular-nums", isPositive ? "text-positive-soft" : "text-danger-soft")}>
              {isPositive ? "+" : ""}{change}%
            </span>
            <span className="text-body-micro-medium text-foreground-tertiary">{changeLabel}</span>
          </div>
        </div>
      </CardContent>
    </Card>
