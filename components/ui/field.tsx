...
const fieldVariants = cva(
  'group/field flex w-full gap-3 data-[invalid=true]:text-danger-soft',
  {
    variants: {
      orientation: {
...
function FieldSeparator({
  ...
  return (
    ...
    >
      ...
      {children && (
        <span
          className="bg-background text-foreground-muted relative mx-auto block w-fit px-2"
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn('text-danger-soft text-sm font-normal', className)}
      {...props}
    >
      {content}
    </div>
