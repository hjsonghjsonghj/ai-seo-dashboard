...
const navigationMenuTriggerStyle = cva(
  'group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium hover:bg-brand-default hover:text-brand-foreground focus:bg-brand-default focus:text-brand-foreground disabled:pointer-events-none disabled:opacity-50 data-[state=open]:hover:bg-brand-default data-[state=open]:text-brand-foreground data-[state=open]:focus:bg-brand-default data-[state=open]:bg-brand-default/50 focus-visible:ring-brand-deep/50 outline-none transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1',
)
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "data-[active=true]:focus:bg-brand-default data-[active=true]:hover:bg-brand-default data-[active=true]:bg-brand-default/50 data-[active=true]:text-brand-foreground hover:bg-brand-default hover:text-brand-foreground focus:bg-brand-default focus:text-brand-foreground focus-visible:ring-brand-deep/50 [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-sm p-2 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
