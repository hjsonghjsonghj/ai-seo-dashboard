...
I built this because I wanted to work in a fully AI-native way, something that isn't fully possible in my current role. Every tool, every decision, every workflow was mine to define.
